...
export const LeftSidebarWrapper = styled.div`
  ...
  width: ${({ showLeftSidebar, sidebarControl }) =>
    showLeftSidebar && sidebarControl == "vertical" ? "200px" : "0"};
...
export const StyledListItemButton = styled(ListItemButton)`
  && {
    ...
    ${({ showLeftSidebar, sidebarControl }) =>
      showLeftSidebar && sidebarControl == "vertical" ? "" : "display: none;"}
  }
  &:hover {
...
export const ListSubheaderStyled = styled(ListSubheader)`
  ...
  ${({ showLeftSidebar, sidebarControl }) =>
    showLeftSidebar && sidebarControl == "vertical"
